...
if __name__ == '__main__':
    ...
    CreateTaggingDetailTable()
    InsertTaggingDetailTable()
    # index表
    conn = get_conn(TaggingToolInfoDB)
    drop_table(conn, TaggingIndexTable)
    CreateTaggingIndexTable()
    InsertTaggingIndexTable()
    ...
    data = 1
    conn = get_conn(TaggingToolInfoDB)
    conn = fetchone(conn, fetchone_sql, data)
    # 更新数据
